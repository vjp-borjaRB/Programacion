...
public class Ejercicio3 {
    ...
    public static void aparcarBus(Autobus[] vectorAutobuses) {
        ...
        Autobus nuevo = new Autobus(matricula);
        do {
            String dni, nombre;
    ...
    public static void mostrarDarsenasLibres(Autobus[] vectorAutobuses) {
    ...
    public static void buscarMatricula(Autobus[] vectorAutobuses) {
        String matricula;
        int i = 0;
        ...
        for (Autobus busI : vectorAutobuses) {
            if (busI != null) {
                if (busI.getListaConductores().containsKey(dni)) {
                    System.out.println("Conductor encontrado en el autobus:");
    ...
    public static void mostrarBusMasConductores(Autobus[] vectorAutobuses) {
