...
public class Ejercicio15 {
    ...
    public static void menu(int[] ventasCoches, String[] meses) {
        int menu;
        do {
            mostrarMenu();
            menu = pedirOpcion();
    ...
    public static void rellenarArray(int[] ventasCoches) {
        int nventas;
        for (int i = 0; i < ventasCoches.length; i++) {
            nventas = (int) (Math.random() * 91) + 10;
            ventasCoches[i] = nventas;
        }
    }

    public static void mostrarVentas(int[] ventasCoches) {
    ...
    public static void mostrarVentasReves(int[] ventasCoches) {
    ...
    public static void mostrarTotalVentas(int[] ventasCoches) {
        int totalVentas = 0;
        for (int i = 0; i < ventasCoches.length; i++) {
            totalVentas += ventasCoches[i];
        }
        System.out.println(totalVentas);
    }

    public static void ventasMesesPares(int[] ventasCoches) {
    ...
    public static void mesMasVentas(int[] ventasCoches, String[] meses) {
        String mejorMes = "";
        int maxVentasMes = 0;
        for (int i = 0; i < ventasCoches.length; i++) {
